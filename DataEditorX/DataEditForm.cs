...
namespace DataEditorX
{
	public partial class DataEditForm : DockContent, IDataForm
	{
		...
		public void InitControl(DataConfig datacfg)
		{
			...
			InitCheckPanel(pl_genre, datacfg.dicGenre);
			//系列名
		...
		public void SetCard(Card c)
		{
			...
			SetCheck(pl_genre, c.genre);
			//Support
			tb_support.Text = c.support.ToString();
			//OCGDate
			tb_ocgdate.Text = c.ocgdate.ToString();
			//TcgDate
			tb_tcgdate.Text = c.tcgdate.ToString();
			//Pendulum
		...
		public Card GetCard()
		{
			...
			//Zeak6464
			int.TryParse(tb_support.Text, out c.support);
			long.TryParse(tb_ocgdate.Text, out c.ocgdate);
			int.TryParse(tb_tcgdate.Text, out c.tcgdate);
		...
		private void tb_atk_TextChanged(object sender, EventArgs e)
		{
		...
		private void tb_script_TextChanged(object sender, EventArgs e)
		{
		...
		private void tb_ocgdate_TextChanged(object sender, EventArgs e)
		{
			
		}

		private void tb_tcgdate_TextChanged(object sender, EventArgs e)
		{
		...
		private void tb_cardcode_TextChanged(object sender, EventArgs e)
		{

		}

		private void tb_support_TextChanged_1(object sender, EventArgs e)
		{

		}

		private void tb_cardalias_TextChanged(object sender, EventArgs e)
		{

		}

		private void lb_categorys_Click(object sender, EventArgs e)
		{
		...
		private void cb_cardrace_SelectedIndexChanged(object sender, EventArgs e)
		{

		}

		private void tb_ocgdate_TextChanged_1(object sender, EventArgs e)
		{
			Console.WriteLine(UnixTimeToDateTime(long.Parse(tb_ocgdate.Text)));
		}
		...
		private void pl_markers_Paint(object sender, PaintEventArgs e)
		{
